...
class HomeController extends ControllerBase {
    ...
    public function CacheTest() {
        ...
        $result = Cacher::Cache("cache_name", $func, 60 * 60 * 24);
        ResponseBag::Add('Result', $result);
        return $this->View();
    }
    ...
    public function SendEmailTest() {
        ...
        Net::SendGmail(
                'your_login_email@gmail.com', 'your password', 'your subject', 'your name display on mail', 'who_you_want_to_send@gmail.com', 'your email content , <br /> it is html body'
        );
    }
